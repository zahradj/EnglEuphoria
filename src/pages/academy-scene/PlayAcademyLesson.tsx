...
export default function PlayAcademyLesson({ roomId, role }: PlayAcademyLessonProps) {
  ...
  const slideOwnImage =
    slide?.type === 'scene_dialogue' || slide?.type === 'conversation_fill' || slide?.type === 'number_chart' || slide?.type === 'number_quiz_game' || slide?.type === 'story_page' || slide?.type === 'letter_sound_game' || slide?.type === 'word_blend'
      ? slide.bg_image_url
