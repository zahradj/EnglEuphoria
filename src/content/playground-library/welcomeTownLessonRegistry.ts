import { LESSON_1_SCENES, LESSON_1_TITLE, LESSON_2_SCENES, LESSON_2_TITLE, LESSON_3_SCENES, LESSON_3_TITLE, LESSON_4_SCENES, LESSON_4_TITLE } from './welcome-town/scenes';
...
const WELCOME_TOWN_LESSON_REGISTRY: Record<string, { scenes: Scene[]; title: string }> = {
  ...
  'wt-rich-1-4': { scenes: LESSON_4_SCENES, title: LESSON_4_TITLE },
