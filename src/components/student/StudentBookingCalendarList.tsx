...
interface StudentBookingCalendarListProps {
  availableSlots: TimeSlot[];
  onBookLesson: (slot: TimeSlot) => void;
  isLoading?: boolean;
}

/** Original date-picker + time-pill list view: pick a highlighted date,
 *  then pick from that day's times. Faster than the grid when a student
 *  already knows roughly which day they want. Selected from
 *  StudentBookingCalendar's list/calendar toggle. */
export const StudentBookingCalendarList = ({
  availableSlots,
  onBookLesson,
  isLoading = false
}: StudentBookingCalendarListProps) => {
