...
When the environment allows web research, search current examples before inventing a new interaction. Prioritize reputable sources and official product documentation.
