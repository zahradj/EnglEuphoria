...
import { JUNGLE_ANIMALS, COLORS } from "@/lib/lesson/jungle";
...
import moonImg from "@/assets/phonics/moon.png";
import mouseImg from "@/assets/phonics/mouse.png";
...
export const Route = createFileRoute("/playground/jungle")({
  head: () => ({
    meta: [
      { title: "Jungle · Lesson 2 — Colors & Descriptions" },
      {
        name: "description",
        content:
          "Pre-A / A1 / A2 Jungle Lesson 2 for ages 4–9: 3 new jungle animals, describe with colors, and a short phonic warm-up.",
      },
      { property: "og:title", content: "Jungle · Lesson 2 — Colors & Descriptions" },
      {
        property: "og:description",
        content: "Three jungle friends + colors: 'It is a tiger. It is orange and black.'",
      },
    ],
  }),
  component: JungleLesson,
});
...
function JungleLesson() {
  ...
  return (
    ...
    >
      ...
      {idx === 2 && <MemoryMatchPhase items={JUNGLE_ANIMALS} pairs={3} onComplete={() => markComplete(2)} />}
      ...
      {idx === 8 && <ChantPhase lines={JUNGLE_CHANT} onComplete={() => markComplete(8)} />}
      {idx === 9 && (
        <BrainBreakPhase
          ...
          games={[
            ...
            },
            {
              ...
              render: ({ onSolved }) => (
                <PicturePuzzle
                  image={JUNGLE_ANIMALS[0].image}
                  label={JUNGLE_ANIMALS[0].name}
                  onSolved={onSolved}
                />
              ),
            },
